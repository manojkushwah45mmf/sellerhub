...
const image_url = {
  ...
  bagicon: baseurl + "/assets/images/bag_icon.png",
  service_provide: baseurl + "/assets/images/bag_icon.png",
  side_logo: baseurl + "assets/images/shawkeen.png",
  count_info: baseurl + "assets/images/circle_graph.png",
  user_photo: baseurl + "assets/images/seller_girl_image.png",
